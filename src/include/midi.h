...
public:
    ...
    */
    ...
    void noteOn(unsigned int note, unsigned int channel=0, unsigned int velocity=127);
    void noteOff(unsigned int note, unsigned int channel=0, unsigned int velocity=0);
    /**
